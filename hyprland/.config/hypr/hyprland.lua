local rp_colors = require("rose-pine")
...
hl.config({
	general = {
		...
		col = {
			active_border = { colors = { rp_colors.rose, rp_colors.pine }, angle = 45 },
			inactive_border = rp_colors.highlight_low,
		},
...
hl.config({
	misc = {
		...
		disable_hyprland_logo = false, -- toggle random hyprland logo / anime girl background
	},
})
